...
| `onPrivateMessage` | `core/runtime.ts` |
| `onTradeRequest` | `core/runtime.ts` |
...
| `core/limits.ts` | CUSTOM_ITEM_START, CUSTOM_MODEL_START, CUSTOM_NPC_START, CUSTOM_OBJECT_START, MAX_CUSTOM_ID, MAX_ITEM_ID, MAX_NPC_ID, MAX_OBJECT_ID |
