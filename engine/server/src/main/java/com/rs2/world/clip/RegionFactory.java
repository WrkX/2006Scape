		...
		while ((incr = str1.getUSmart()) != 0) {
			...
			while ((incr2 = str1.getUSmart()) != 0) {
				...
				if (objectHeight >= 0 && objectHeight <= 3) {
					com.rs2.world.WorldObjectService.getInstance().loadCacheObject(
							new com.rs2.game.objects.Objects(objectId, regionX + objectX,
									regionY + objectY, objectHeight, direction, type, 0));
				}
			}
		}
	}
