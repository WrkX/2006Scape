...
public class Trawler extends GroupMinigame {
        ...
        public void resetWalls() {
                for(Wall w : Wall.values()) {
                        if(w != null) {
                                GameEngine.objectHandler.removeObject(GameEngine.objectHandler.getObjectByPosition(w.x, w.y, 0, 10));
        ...
        public void updateWall(int index) {
                ...
                GameEngine.objectHandler.removeObject(GameEngine.objectHandler.getObjectByPosition(w.x, w.y, 0, 10));
                GameEngine.objectHandler.removeObject(GameEngine.objectHandler.getObjectByPosition(w.x + (isSunk ? -128 : 128), w.y, 0, 10));
