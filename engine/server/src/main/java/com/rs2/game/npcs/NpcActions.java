...
public class NpcActions {
    ...
    public void firstClickNpc(int npcType) {
        ...
        lastClickHandledByScript = dispatchScriptedClick(npcType, "first");
    ...
    public void secondClickNpc(int npcType) {
        ...
        player.rememberNpcIndex = player.npcClickIndex;
        player.npcClickIndex = 0;
        lastClickHandledByScript = dispatchScriptedClick(npcType, "second");
        if (lastClickHandledByScript) {
            return;
        }
    ...
    public void thirdClickNpc(int npcType) {
        ...
        player.rememberNpcIndex = player.npcClickIndex;
        player.npcClickIndex = 0;
        lastClickHandledByScript = dispatchScriptedClick(npcType, "third");
        if (lastClickHandledByScript) {
            return;
        }
        if (Pets.isCat(npcType)) {
