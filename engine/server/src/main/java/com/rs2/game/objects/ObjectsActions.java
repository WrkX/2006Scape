        ...
        switch (objectType) {
                ...
                if (player.tutorialProgress == 7 || player.diedOnTut) {
                    if (player.diedOnTut) {
                        ...
                        player.getDialogueHandler().sendStatement(
                                ...
                                "you may continue.");
                    } else if (player.diedOnTut == false && player.absX > player.objectX) {
                        player.getPlayerAssistant().movePlayer(player.absX - 1,
                                player.absY, 0);
            ...
            case 3018: // door again
                if (player.tutorialProgress > 9) {
                    if (player.absX > player.objectX) {
                        ...
                        PassDoor.passThroughDoor(player, 3018, 2, 1, 0, 1, 0, 0);
                    }
                    if (player.diedOnTut) {
                        player.getDialogueHandler().sendStatement(
                                "You have died and have already beat this step",
            ...
            case 3017:// door tutorial island
                if (player.tutorialProgress > 6 || player.diedOnTut) {
                    ...
                    } else if (player.diedOnTut == false && Position.checkPosition(player, 3079, 3083, 0)) {
                        PassDoor.passThroughDoor(player, 3017, 0, 3, 0, 0, 1, 0);
                    }
                } else {
            ...
            case 3025:
                if (player.tutorialProgress >= 28) {
                    ...
                    } else if (Position.checkPosition(player, 3129, 3125, 0)) {
                        PassDoor.passThroughDoor(player, 3025, 0, 3, 0, 0, -1, 0);
                    }
            ...
            case 3026:
                if (player.tutorialProgress >= 32) {
                    ...
                    } else if (Position.checkPosition(player, 3122, 3102, 0)) {
                        PassDoor.passThroughDoor(player, 3026, 1, 0, 0, 0, 1, 0);
                    }
                }
                break;
            ...
            case 3024:
                if (player.tutorialProgress >= 27) {
                    ...
                    } else if (Position.checkPosition(player, 3124, 3125, 0)) {
                        PassDoor.passThroughDoor(player, 3024, 0, 3, 0, 0, -1, 0);
                    }
                ...
                if (player.tutorialProgress >= 11 || player.diedOnTut) {
                    if (player.diedOnTut && Position.checkPosition(player, 3086, 3126, 0)) {
                        ...
                        player.getPacketSender().createArrow(3088, 3119,
                                player.getH(), 2);
                    } else if (Position.checkPosition(player, 3086, 3126, 0)) {
                        player.getDialogueHandler().sendDialogues(3042, -1);
                    } else if (Position.checkPosition(player, 3086, 3125, 0)) {
                        PassDoor.passThroughDoor(player, 3019, 3, 2, 0, 0, 1, 0);
                    }
                }
                break;
            ...
            case 3014:
                ...
                } else if (Position.checkPosition(player, 3097, 3108, 0) && player.tutorialProgress >= 2) {
                    PassDoor.passThroughDoor(player, 3014, 0, 1, 0, 0, -1, 0);
