 ...
 *
 * Phase 5 WP10: the tables register under the `dragon-island-drops` content
 * module so operator diagnostics can attribute them to a logical source.
 * Boss, area, and raid definitions reference the table ids from their own
 * modules; candidate-scoped cross-references resolve within the candidate,
 * not within one module.
 *
 * @module drops/dragon-island
 */

import { createDropTable, registerModule } from "../sdk/index.js";

registerModule({ id: "dragon-island-drops", schemaVersion: 1 }, () => {
  /**
