 ...
 *
 * Phase 5 WP10: the raid, its reward, and its loot table register under the
 * `temple-of-zaros` content module.
 *
...
import type { RaidRoomContext, RoomResult } from "../../sdk/index.js";

registerModule({ id: "temple-of-zaros", schemaVersion: 1 }, () => {
